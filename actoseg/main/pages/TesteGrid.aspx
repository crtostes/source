<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TesteGrid.aspx.cs" Inherits="actoseg.main.pages.TesteGrid" %>
...
<head>
  <meta charset="utf-8">
    ...
    <title>Bankio admin - Dashboard  Data Tables</title>
          ...
          <div class="box">
            <div class="box-header with-border bg-light">
			  ...
			  <div class="box-controls pull-right">
				  ...
				  <button id="testeGrid" class="btn btn-xs btn-danger">Delete selected row</button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				<div class="table-responsive">
				<table id="example" class="table table-bordered table-striped display nowrap margin-top-10" style="width:100%">
